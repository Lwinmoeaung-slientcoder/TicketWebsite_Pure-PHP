 <?php include_once "Nav.php" ?>
    ...
    <section class="home-about-area section-gap">
      <div class="container">
        ...
        <div class="nav">
          <ul>
            <li class="tutorials"><a class="active" href="#">Future Plan</a></li>
            <li class="about"><a href="Annousement.php">Anousement</a></li>
            <li class="news"><a href="Members.php">Members</a></li>
          </ul>
        </div>
        </div>
          ...
          <div class="text-center">
              <div class="menu-content pb-70">
                  <div class="title text-center">
                      <h1 class="mb-10">Our FuturePlan</h1>
